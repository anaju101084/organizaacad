...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirAtividade = "INSERT INTO atividades (matriculaUsuario, fotoAtividade, materiaAtividade, prazoAtividade, instrucoesAtividade) VALUES ('$matriculaUsuario','$fotoAtividade', '$materiaAtividade', '$prazoAtividade', '$instrucoesAtividade')";
            ...
            if(mysqli_query($conn, $inserirAtividade)){
                echo "
                ...
                echo "<div class='alert alert-danger text-center'>Erro ao tentar cadastrar <strong>Atividade</strong></div>" . mysqli_error($conn);
            }
