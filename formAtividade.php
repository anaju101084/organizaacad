        ...
        <div class="d-flex justify-content-center mb-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <form action="actionAtividade.php" class="was-validated" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary">Cadastrar Atividade Pelo Aluno</button>
                    </form>
                </div>
            </div>
        </div>
