...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($_FILES['fotoAtividade']['size'] != 0){
            ...
            if(!move_uploaded_file($_FILES['fotoUsuario']['tmp_name'], $fotoAtividade)){
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirAtividade = "INSERT INTO Atividades (fotoAtividade, materiaAtividade, prazoAtividade, instruicoesAtividade) VALUES ('$fotoAtividade', '$materiaAtividade', '$prazoAtividade', '$instruicoesAtividade')";
