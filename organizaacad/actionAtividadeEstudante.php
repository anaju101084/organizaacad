...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            $inserirAtividade = "INSERT INTO Atividade (matriculaUsuario, fotoAtividade, materiaAtividade, prazoAtividade, instrucoesAtividade) VALUES ('$matriculaUsuario','$fotoAtividade', '$materiaAtividade', '$prazoAtividade', '$instrucoesAtividade')";
