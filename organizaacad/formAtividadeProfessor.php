        ...
        <div class="d-flex justify-content-center mb-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <form action="actionAtividadeProfessor.php" class="was-validated" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary">Cadastrar Atividade Pelo Professor</button>
                    </form>
                </div>
            </div>
        </div>
